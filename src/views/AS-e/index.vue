...
<!-- 这是第一部分传感器 -->
    <div class="content" v-if="activeLink === 'link1'">
        <!-- 上方检索部分 -->
        <div class="row m-3">
            <div class="col-2">
            ...
            <div class="col-3 row">
                <div class="col-9"><input type="text" name="" id="" class="form-control" placeholder="请输入要搜索的传感器名称"></div>
...
<!-- 这是第二部分控制器 -->
    <div class="content" v-if="activeLink === 'link2'">
         <div class="row m-3">
            <div class="col-2">
                <select name="" id="" class="form-control"></select>
            </div>
            <div class="col-3 row">
                <div class="col-9"><input type="text" name="" id="" class="form-control" placeholder="请输入要搜索的控制器名称"></div>
                <div class="col-3"> <button class="btn btn-info">搜索</button></div>
...
<!-- 这是第三部分摄像头 -->
    <div class="content" v-if="activeLink === 'link3'">
         <div class="row m-3">
            <div class="col-2">
                <select name="" id="" class="form-control"></select>
            </div>
            <div class="col-3 row">
                <div class="col-9"><input type="text" name="" id="" class="form-control" placeholder="请输入要搜索的摄像头名称"></div>
                <div class="col-3"> <button class="btn btn-info">搜索</button></div>
