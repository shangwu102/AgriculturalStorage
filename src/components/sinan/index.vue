<template>
  <div class="wrap-container sn-container">
    <div class="sn-content">
      <div class="sn-title">粮食储备排名</div>
      <div class="sn-body">
        <div class="wrap-container">
          <div class="pd-main">
            <div id="chart1" class="chart-1">
              <div class="compass">
                <div class="compass-bg-1" />
                <div class="compass-bg-2" />
                <div class="compass-bg-3" />
                <div class="compass-bg-4" />
                <div class="compass-bg-5" />
                <div class="compass-bg-6" />
                <div class="compass-bg-7" />

                <div class="compass-bg-c-1" />
                <div class="compass-bg-c-2" />
                <div class="compass-bg-c-3" />
                <div class="compass-bg-c-4" />

                <div v-for="(item, index) in arr" :key="index" class="compass-text" :class="[`compass-text-${index + 1}`, {show: number == index}]">
                  <span>入库量：{{ item.dataWarehousing }}</span>
                  <span>出库量：{{ item.dataOutbound }}</span>
                </div>
                <div class="compass-number">
                  <div v-for="(item, index) in arr" :key="index" :title="`${index + 1}`" :class="[`rank-${index + 1}`, {szscale: number == index}]">
...
export default {
  ...
  data() {
    return {
      ...
      arr: [{
        id: 1,
        dataWarehousing: 1288,
        dataOutbound: 12306,
        workUnit: '小麦'
      }, {
        id: 2,
        dataWarehousing: 5623,
        dataOutbound: 12306,
        workUnit: '玉米'
      }, {
        id: 3,
        dataWarehousing: 1755,
        dataOutbound: 12043,
        workUnit: '稻谷'
      }, {
        id: 4,
        dataWarehousing: 1812,
        dataOutbound: 12306,
        workUnit: '大豆'
      }, {
        id: 5,
        dataWarehousing: 4718,
        dataOutbound: 12580,
        workUnit: '高粱'
      }]
    }
