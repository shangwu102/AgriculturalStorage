<template>
  <div class="wrap-container sn-container">
    <div class="sn-content">
      <div class="sn-title">区块链信息</div>
      <div class="sn-body">
        <div class="wrap-container pd-info">
          <div class="pd-info-center">
            <div class="y-center">
              <div class="info-1-0 animated infinite rotateF" />
              <div class="info-1-1 animated infinite rotateF" />
              <div class="info-1-2 animated infinite rotate" />
              <div class="info-1-3 animated infinite rotate" />
              <div class="info-1-4 animated infinite flashPD" />
            </div>

            <div class="y-number y-number-1 animated fadeInLeft">
              <div class="y-number-bg animated infinite rotate" />
              <div class="y-number-icon" />
            ...
            <div class="y-number y-number-2 animated fadeInLeft">
              <div class="y-number-bg animated infinite rotateF" />
              <div class="y-number-icon" />
              <div class="y-number-text">
                <span>交易总量</span>
